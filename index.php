            ...
            <div class="card-body">
                <form action="" method="post" class="p-5">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="event_type" id="event_type"  onchange="generateInputs()">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="no_of_participants" id="no_of_participants"  onchange="generateInputs()">
                            <option value="default" selected>---</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="no_of_teachers" id="no_of_teachers"  onchange="generateInputs()">
                            <option value="default" selected>---</option>
